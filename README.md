...
2. 后台通过 OpenClaw 当前主 Agent 生成中文旁白稿，写入 `runs/<job_id>/script.txt`，状态更新为 `ready`
3. 在 Web UI 审核 / 编辑文稿
...
- 睡前可持续聆听的口语旁白，非知识科普文章
- 第二人称代入，但不强制每篇都从床、黑暗或呼吸开始
- 前 30 秒内明确主题、核心矛盾和核心画面
- 低认知负荷；知识点是垫脚石，不是课堂讲义
- 纯散文，自然分段；无标题、无标签、无 markdown
- 具体日期、数字、任务和研究结论先核验，准确性优先于戏剧性
- 品牌落款按结尾语气选用，不强制
